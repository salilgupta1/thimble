...
urlpatterns = patterns('',
    ...
    # create
    url(r'^create-design-story/$', create.create_design_story, name='create_design_story'),
    ...
    # community activites
    # like
    url(r'^like-story/$', community.like_design_story, name='like_design_story'),
    url(r'^unlike-story/$', community.unlike_design_story, name='unlike_design_story'),
